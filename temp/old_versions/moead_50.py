"""
MOEA/D with Proper Normalization
...
class MOEAD_50:
    ...
    def __init__(self, main_package, pop_size=100, n_neighbors=20, max_gen=50,
        ...
        self.archive_limit = 50  # Reduzido para 50
        ...
        print(f"MOEA/D Normalized initialized for '{main_package}'")
